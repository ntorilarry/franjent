      ...
      <div className="flex w-full flex-col justify-between px-8 py-10 sm:px-16 lg:w-1/2 lg:px-24">
        <div className="mx-auto w-full max-w-md flex-1 flex flex-col justify-center">
          ...
          <p className="mt-8 text-center text-[11px] leading-relaxed text-gray-400">
            By signing, you agree to the Journey{" "}
            ...
            , which describe how your personal data is collected, used and
            shared by Journey and/or its affiliates. I also consent to the
            processing and international transfer of my personal data as
            described in the Privacy Policy. Please also see the country and
            state specific information and policy related to Marriott Bonvoy.
          </p>
        </div>
