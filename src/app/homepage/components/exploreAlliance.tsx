...
const cards = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=400&h=500&fit=crop",
  },
  {
    name: "Annex",
    location: "Johnson City, TX",
    image:
      "https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=400&h=500&fit=crop",
  },
  {
    name: "Haven",
  ...
  },
  {
    ...
    location: "Ojai, CA",
    image:
      "https://images.unsplash.com/photo-1505843513577-22bb7d21e455?w=400&h=500&fit=crop",
  },
  {
    name: "The Barn",
    location: "Hudson, NY",
    image:
      "https://images.unsplash.com/photo-1540202404-a2f29016b523?w=400&h=500&fit=crop",
  },
  {
    name: "Cervo",
    location: "Zermatt, CH",
    image:
      "https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=400&h=500&fit=crop",
  },
  {
    name: "Kokomo",
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden w-full aspect-[3/4] shrink-0">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4">
        <p className="text-white text-base font-light tracking-wide mb-1">
          {name}
        </p>
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 ">
        ...
        <p className="text-white text-sm sm:text-base max-w-2xl mb-6 ">
          We&apos;ve done the searching for you, bringing together places shaped
          by passionate hoteliers and hosts who pour care, character, and
          intention into every stay.
        </p>
        <Link href="/alliance">
